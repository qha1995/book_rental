  ...
  const MAINSLIDRE = [
    {
      ...
      tit: "회사소개",
      con: "신시웨이 브랜드 소개",
      des: "방문 전 에버랜드 온라인 회원가입 및 APP을 꼭 설치해주세요.",
      link: "/sub01",
    },
    {
      id: 1,
      tit: "요금&제휴카드",
      con: "에버랜드 이용 요금 안내",
      des: "365일 축제의 나라 에버랜드 ! 알차게 즐기고 싶다면 제휴카드를 확인하세요.",
      link: "/sub02",
    },
    {
      id: 2,
      tit: "즐길거리",
      con: "어트랙션 즐기기 추천 코스 ",
      des: "기상 상황 및 시즌에 따라 어트랙션 및 공연 관람이 변동될 수 있습니다. 에버랜드 App에서 운휴 및 대기시간 정보를 확인해주세요.",
      link: "/sub03",
    },
    {
      id: 3,
