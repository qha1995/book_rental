...
//   const getApi = async () => {
//     setLoad(true)
//     const r = await axios.get(`https://apis.data.go.kr/4050000/libebook/getLibebook?serviceKey=nmPIjJ%2Bj0FufPiP6k4BLPlq3n%2B46QZN%2B6hgSINrrxqk3nNwnoHX2ynqX6Dlgr3xFeivGPus2vgmh6Ifx1vdu1g%3D%3D&pageNo=${pageNo}&numOfRows=100`);
//     getBook(r.data);
//     setLoad(false)
//   }
...
//                   <h3>{idx + 1} : {it.ebk_nm}</h3>
//                   <em>{it.gnr} 저자 : {it.aut_nm}</em>
//                   <p>{it.cn_intro}</p>
//                   <b>{it.pblsh_ymd}</b>
